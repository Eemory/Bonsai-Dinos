...
export function setupDino() {
    ...
    document.removeEventListener('touchstart', onJump)             //removes event listener so they don't stack
    document.addEventListener('touchstart', onJump)                //allows jump upon keystroke
}
